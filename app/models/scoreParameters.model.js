  ...
  var schema = mongoose.Schema(
    {
      ...
      preAcceptanceRecencyDays: { type: Number, default: 180 },
      preAcceptanceBankFullBonus: { type: Number, default: 15 },
      preAcceptanceCourtierFullBonus: { type: Number, default: 10 },
      preAcceptanceBankPartialBonus: { type: Number, default: 8 },
      preAcceptanceCourtierPartialBonus: { type: Number, default: 5 },
      preAcceptanceBankNoAmountBonus: { type: Number, default: 6 },
      preAcceptanceCourtierNoAmountBonus: { type: Number, default: 4 },
      preAcceptanceUnknownEmitterBonus: { type: Number, default: 3 },
      feesRate: {
